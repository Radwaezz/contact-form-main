...
//                 abortEarly: false
//             });
//             setSuccessMessage('Message is sent!'); // Set success message
//             setErrorsArray([]); // Clear errors
//         } catch (err) {
//             var errors = [];
...
//                 <div className="form-group">
//                 {/* <div className={`form-group ${errorsArray.some(error => error.key === 'queryType') ? 'error-radio' : ''}`}> */}
